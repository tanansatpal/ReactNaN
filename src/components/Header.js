...
class Header extends React.Component {
  ...
  render() {
    return (<header
        className={"header " + (this.props.location.pathname === "/" ? "header-absolute" : '')}>
            ...
            <div className="row d-flex align-items-center">
              <div className="col-sm-7 d-none d-sm-block">
                <ul className="list-inline mb-0">
                  ...
                  <li className="list-inline-item px-3 border-left d-none d-lg-inline-block">Free shipping on orders
                    over
                    $300
                  </li>
                </ul>
        ...
        <nav
          className={"navbar navbar-expand-lg navbar-sticky navbar-airy bg-fixed-white " + (this.props.location.pathname === "/" ? "bg-transparent bg-white navbar-dark bg-hover-white navbar-hover-light navbar-fixed-light" : 'navbar-light')}>
          <div className="container-fluid">
            ...
            <div id="navbarCollapse" className="collapse navbar-collapse">
              <ul className="navbar-nav mx-auto">
                ...
                <li className="nav-item dropdown position-static"><a href="#" data-toggle="dropdown"
                                                                     className="nav-link">Template<i
                          ...
                          <div className="col-lg-3">
                            ...
                            <ul className="megamenu-list list-unstyled">
                              <li className="megamenu-list-item"><a href="customer-login.html"
                                                                    className="megamenu-list-link">Login/sign up </a>
                              </li>
                              ...
                              <li className="megamenu-list-item"><a href="customer-order.html"
                                                                    className="megamenu-list-link">Order detail </a>
                              </li>
