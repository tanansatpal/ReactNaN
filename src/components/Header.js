      ...
      <div className="container-fluid">
        <div className="row d-flex align-items-center">
          ...
          <div className="col-sm-5 d-flex justify-content-end">
            <div className="dropdown border-right px-3"><a id="langsDropdown" href="https://example.com"
    ...
    <nav
      ...
      <div className="container-fluid">
        <button type="button" data-toggle="collapse" data-target="#navbarCollapse" aria-controls="navbarCollapse"
                aria-expanded="false" aria-label="Toggle navigation" className="navbar-toggler navbar-toggler-right"><i
          className="fa fa-bars"></i></button>
        <div id="navbarCollapse" className="collapse navbar-collapse">
          <ul className="navbar-nav mx-auto">
            <li className="nav-item dropdown"><a id="homeDropdownMenuLink" href="index.html" data-toggle="dropdown"
                                                 aria-haspopup="true" aria-expanded="false" className="nav-link active">
            ...
            <li className="nav-item"><a href="category.html" className="nav-link">Shop</a>
            </li>
              ...
              <div className="dropdown-menu megamenu py-lg-0">
                <div className="row">
                    ...
                    <div className="row p-3 pr-lg-0 pl-lg-5 pt-lg-5">
                      <div className="col-lg-3">
                        ...
                        <ul className="megamenu-list list-unstyled">
                          ...
                          <li className="megamenu-list-item"><a href="category-banner.html"
                                                                className="megamenu-list-link">Category - w/ banner </a>
                          </li>
                      ...
                      <div className="col-lg-3">
                        ...
                        <ul className="megamenu-list list-unstyled">
                          ...
                          <li className="megamenu-list-item"><a href="coming-soon.html" className="megamenu-list-link">Coming
                            soon </a></li>
                        </ul>
                      ...
                      <div className="col-lg-3">
                        ...
                        <ul className="megamenu-list list-unstyled">
                          ...
                          <li className="megamenu-list-item"><a href="docs/docs-directory-structure.html"
                                                                className="megamenu-list-link">Directory structure </a>
                          </li>
                          ...
                          <li className="megamenu-list-item"><a href="docs/docs-customizing-css.html"
                                                                className="megamenu-list-link">Customizing CSS </a></li>
                  ...
                  <div className="col-lg-3 d-none d-lg-block"><img
                    src="https://d19m59y37dris4.cloudfront.net/sell/1-2-2/img/megamenu.jpg" alt="" className="bg-image" />
                  </div>
                </div>
              </div>
            </li>
            ...
            <li className="nav-item dropdown"><a id="docsDropdownMenuLink" href="index.html" data-toggle="dropdown"
          ...
          <div className="d-flex align-items-center justify-content-between justify-content-lg-end mt-1 mb-2 my-lg-0">
            ...
            <div className="nav-item"><a href="customer-login.html" className="navbar-icon-link">
              <svg className="svg-icon">
                <use xlinkHref="#male-user-1"></use>
              </svg>
              <span
                className="text-sm ml-2 ml-lg-0 text-uppercase text-sm font-weight-bold d-none d-sm-inline d-lg-none">Log in    </span></a>
            </div>
            <div className="nav-item dropdown"><a href="cart.html" className="navbar-icon-link d-lg-none">
              ...
              <span
                className="text-sm ml-2 ml-lg-0 text-uppercase text-sm font-weight-bold d-none d-sm-inline d-lg-none">View cart</span></a>
              <div className="d-none d-lg-block"><a id="cartdetails" data-toggle="dropdown" aria-haspopup="true"
                ...
                <div aria-labelledby="cartdetails" className="dropdown-menu dropdown-menu-right p-4">
                  <div className="navbar-cart-product-wrapper">
                    <div className="navbar-cart-product">
                      <div className="d-flex align-items-center"><a href="detail.html"><img
                        ...
                        <div className="w-100"><a href="#" className="close text-sm mr-2"><i
                          ...
                          <div className="pl-3"><a href="detail.html" className="navbar-cart-product-link">Skull Tee</a>
                    ...
                    <div className="navbar-cart-product">
                      <div className="d-flex align-items-center"><a href="detail.html"><img
                        ...
                        <div className="w-100"><a href="#" className="close text-sm mr-2"><i
                          className="fa fa-times"> </i></a>
                          <div className="pl-3"><a href="detail.html" className="navbar-cart-product-link">White Tee</a>
                            <small className="d-block text-muted">Quantity: 1</small>
                            <strong className="d-block text-sm">$75.00 </strong></div>
                        </div>
                      </div>
                  ...
                  <div className="d-flex justify-content-between"><a href="cart.html"
                                                                     className="btn btn-link text-dark mr-3">View
                    Cart <i className="fa-arrow-right fa"></i></a><a href="checkout1.html"
                                                                     className="btn btn-outline-dark">Checkout</a></div>
                </div>
              </div>
            </div>
          </div>
