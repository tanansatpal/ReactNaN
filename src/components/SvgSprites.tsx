...
export default function SvgSprites() {
    return (<svg width="0" height="0" className="hidden">
        ...
        <symbol viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" id="woman-1">
            <title>Woman</title>
            <desc>A line styled icon from Orion Icon Library.</desc>
            <path stroke-miterlimit="10" stroke="#202020" fill="none"
        ...
        <symbol viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" id="destination-map-1">
            ...
            <path
                ...
                stroke-linejoin="round" stroke-linecap="round" style={{stroke: "var(--layer1, #202020)"}}></path>
            <path d="M62 10v50l-22-6-16 6-22-6V4l22 6 16-6 22 6z" stroke-miterlimit="10" stroke="#202020" fill="none"
                  data-name="layer1"
                  stroke-linejoin="round" stroke-linecap="round" style={{stroke: "var(--layer1, #202020)"}}></path>
        </symbol>
        ...
        <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" id="landline-1">
            ...
            <rect data-name="layer2" x="20" y="30" width="4" height="4" rx="1"
                  ry="1" fill="none" stroke="#202020" stroke-miterlimit="10" stroke-linejoin="round"
                  stroke-linecap="round" style={{stroke: "var(--layer1, #202020)"}}></rect>
        ...
        <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" id="label-tag-1">
            ...
            <desc>A line styled icon from Orion Icon Library.</desc>
            <path data-name="layer2"
                  fill="none" stroke="#202020" stroke-miterlimit="10"
        ...
        <symbol viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" id="money-1">
            ...
            <path stroke-miterlimit="10" stroke="#202020"
                  ...
                  stroke-linejoin="round" stroke-linecap="round" style={{stroke: "var(--layer2, #202020)"}}></path>
            <path d="M22.018 12.832v-2.831m0 23.998v-2.832" stroke-miterlimit="10" stroke="#202020" fill="none"
                  data-name="layer2"
                  stroke-linejoin="round" stroke-linecap="round" style={{stroke: "var(--layer2, #202020)"}}></path>
        ...
        <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" id="bank-cards-1">
            ...
            <rect data-name="layer1" x="2" y="29" width="48" height="30" rx="2.4"
                  ry="2.4" fill="none" stroke="#202020" stroke-miterlimit="10" stroke-linejoin="round"
                  stroke-linecap="round" style={{stroke: "var(--layer1, #202020)"}}></rect>
            <path data-name="layer1" fill="none" stroke="#202020" stroke-miterlimit="10"
