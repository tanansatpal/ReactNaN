          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-6">
              <ul className="list-inline mb-0 mt-2 mt-md-0 text-center text-md-right">
                ...
                <li className="list-inline-item"><img
                  src="https://d19m59y37dris4.cloudfront.net/sell/1-2-2/img/paypal.svg" alt="..." className="w-2rem"/>
                </li>
                <li className="list-inline-item"><img
                  src="https://d19m59y37dris4.cloudfront.net/sell/1-2-2/img/western-union.svg" alt="..."
                  className="w-2rem"/></li>
              </ul>
            </div>
          </div>
